...
h1=figure(1);h11=gca;imagesc(currClasses)
grid on;zoom on
h2=figure(2);h21=gca;imagesc(currDatadw)
colormap gray;zoom on
h3=figure(3);h31=gca;imagesc(currDataup)
colormap gray;zoom on
h1.Position=[225 40 1080 730];h2.Position=[1     450 320 330];h3.Position=[1210  450 320 330];
