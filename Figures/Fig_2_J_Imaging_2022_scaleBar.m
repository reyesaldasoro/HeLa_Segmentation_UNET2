...
Hela8000F   = imfilter(Hela8000,gaussF(5,5,1),'replicate');

%% Scale bar
% Pixel size is 10 nm thus a 5 microns scale bar is 500 pixels
Hela8000F (7700:7800,6200:6700) = 0;
...
print('-dpng','-r400','Fig_2_JImaging_2022_scaleBar.png')
