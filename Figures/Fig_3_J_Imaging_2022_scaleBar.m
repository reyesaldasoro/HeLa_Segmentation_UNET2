...
for  k=1:5
    ...
    h{k} = subplot(1,5,k);
    currentDataF        = imfilter(currentData,gaussF(5,5,1),'replicate');
    currentDataF(1800:1850,1300:1800) = 0;
    imagesc(currentDataF)
    axis off
end
colormap gray
...
print('-dpng','-r400','Fig_3_J_Imaging_2022_scaleBar.png')
